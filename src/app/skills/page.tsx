...
import { FaReact, FaHtml5, FaCss3Alt, FaJsSquare, FaPython, FaDatabase, FaServer, FaNodeJs, FaSearch, FaLaptopCode, FaBrain, FaChartBar, FaLanguage, FaRobot } from "react-icons/fa";
import { SiNextdotjs, SiTailwindcss, SiTypescript, SiExpress, SiDjango, SiMongodb, SiFirebase, SiPostgresql, SiGit, SiGithub } from "react-icons/si";
...
items: [
  ...
  { name: "Artificial Intelligence", level: 75, icon: <GiArtificialIntelligence className="text-pink-500" /> },
  { name: "Natural Language Processing (NLP)", level: 70, icon: <FaRobot className="text-green-600" /> },
...
export default function SkillsSection() {
  ...
  // تصفية المهارات بناءً على البحث والفئة
...
<>
      ...
      {/* <Helmet>
        <title>Skills - Alaa Soudy</title>
        <meta name="description" content="Skills and expertise of Alaa Soudy" />
 ...
 */}
    ...
    <section id="skills" className="m-3 w-full py-16 px-4 md:px-8 relative overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      {/* تأثيرات الخلفية */}
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        >
          <h3 className="flex items-center justify-center gap-4 text-[#6B76DD] font-semibold">
            ...
            <span className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Technical Skills</span>
            <span className="w-12 h-[2px] bg-[#6B76DD] block"></span>
          </h3>
          <p className="text-sm mt-3 max-w-2xl mx-auto text-gray-700 dark:text-gray-300">
            My technical proficiency across various domains of software development, continuously evolving with new technologies and best practices.
          </p>
        </motion.div>

        {/* عناصر التحكم: البحث والتصفية */}
        <motion.div 
            ...
            {filteredSections.map((sec, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-5 relative z-10">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{sec.title}</h4>
                </div>
                ...
                <div className="flex flex-col gap-4 relative z-10">
                  {sec.items.map((skill, idx) => (
                    ...
                    >
                      {/* أيقونة */}
                      <div className="text-lg opacity-80 group-hover/skill:scale-110 transition-transform duration-300">{skill.icon}</div>

                      {/* اسم المهارة */}
                      <div className="w-28 md:w-36 text-sm font-medium text-gray-800 dark:text-gray-200">{skill.name}</div>
                      ...
                      {/* النسبة */}
                      <div className="w-10 text-xs font-medium text-gray-600 dark:text-gray-300 text-right">{skill.level}%</div>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
        ...
        <AnimatePresence>
          {filteredSections.length === 0 && (
            ...
            >
              ...
              <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-2">No skills found</h4>
