          ...
          >
            <div className="text-center">
              ...
              >
                ...
                student with a strong focus on front-end development and AI technologies. I love
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Front-End Web Development with HTML, CSS, JavaScript, React.js, Next.js, Tailwind,
                  and Bootstrap
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  AI & Machine Learning applications in engineering projects and real-world problem
                  solving
                </p>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-3 text-xl">
                  Problem Solving
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-center">
                  Staying updated with the latest tech trends and tools
                </p>
              </motion.div>
            </div>
          </motion.section>
